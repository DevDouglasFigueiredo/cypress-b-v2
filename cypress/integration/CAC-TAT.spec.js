...
describe('Central de Atendimento ao Cliente TAT', function () {
    ...
    it('preenche os campos obrigatórios e envia o formulário', function () {
        ...
        cy.get('#open-text-area').type('obrigado pelo atendimento, huheaaheuaheugheaughea', { delay: 0 }).should('have.value', 'obrigado pelo atendimento, huheaaheuaheugheaughea')
